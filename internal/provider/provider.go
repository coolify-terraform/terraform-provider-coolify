...
import (
	...
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/database/clickhouse"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/database/dragonfly"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/database/keydb"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/database/mariadb"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/database/mongodb"
	...
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/instanceemail"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/notificationdiscord"
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/notificationemail"
	...
	"github.com/coolify-terraform/terraform-provider-coolify/internal/service/notificationtelegram"
...
func (p *coolifyProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		instanceemail.NewResource,          // coolify_instance_email_settings
...
func (p *coolifyProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		hetzner.NewFirewallsDataSource,
		...
		notificationslack.NewDataSource,
		notificationtelegram.NewDataSource,
		notificationwebhook.NewDataSource,
