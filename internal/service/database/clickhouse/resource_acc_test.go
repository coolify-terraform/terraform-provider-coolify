...
func TestAccClickhouseDatabaseResource_CRUD(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Create
			{
				Config: testAccClickhouseConfig(name, serverUUID, ""),
			...
			{
				Config: testAccClickhouseConfig(name, serverUUID, `description = "Updated via acc test"`),
...
func testAccClickhouseConfig(name, serverUUID, extra string) string {
