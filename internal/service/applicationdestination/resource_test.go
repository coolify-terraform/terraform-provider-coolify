...
func TestApplicationDestinationResource_CreateAPIError(t *testing.T) {
	t.Parallel()
	mux := http.NewServeMux()
	mux.HandleFunc("POST /api/v1/applications/{uuid}/destinations", func(w http.ResponseWriter, _ *http.Request) {
...
resource "coolify_application_destination" "test" {
  ...
  destination_uuid = "dddd0001-0001-4000-8000-000000000001"
}`,
			ExpectError: regexp.MustCompile(`Error attaching application destination`),
		}},
	})
}
