...
`, srv.URL),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.coolify_application.test", "dockerfile_location", "/Dockerfile"),
					resource.TestCheckResourceAttr("data.coolify_application.test", "docker_compose_location", "/compose.yaml"),
