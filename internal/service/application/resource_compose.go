...
func flattenDockerComposeApplication(app *client.Application, state *dockerComposeApplicationResourceModel) {
	...
	flattenLimitsAndHealth(app, commonAppFields{
		LimitsMemory:            &state.LimitsMemory,
		LimitsMemorySwap:        &state.LimitsMemorySwap,
		LimitsMemorySwappiness:  &state.LimitsMemorySwappiness,
		LimitsMemoryReservation: &state.LimitsMemoryReservation,
		LimitsCPUs:              &state.LimitsCPUs,
		LimitsCPUSet:            &state.LimitsCPUSet,
		LimitsCPUShares:         &state.LimitsCPUShares,
		HealthCheckEnabled:      &state.HealthCheckEnabled,
		HealthCheckPath:         &state.HealthCheckPath,
		HealthCheckPort:         &state.HealthCheckPort,
		HealthCheckInterval:     &state.HealthCheckInterval,
		HealthCheckTimeout:      &state.HealthCheckTimeout,
		HealthCheckRetries:      &state.HealthCheckRetries,
		HealthCheckStartPeriod:  &state.HealthCheckStartPeriod,
		IsAutoDeployEnabled:     &state.IsAutoDeployEnabled,
	})
}
