	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Step 5: Import by UUID
			{
				...
				ImportStateVerifyIgnore:              []string{"environment_name", "github_app_uuid", "project_uuid", "server_uuid", "dockerfile", "container_present"}, // github_app_uuid is not returned by the API after import
			},
		},
	})
}
