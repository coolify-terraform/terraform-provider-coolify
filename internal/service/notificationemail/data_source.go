...
func (d *emailDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	...
	attrs := map[string]schema.Attribute{
		...
		"smtp_ehlo_domain":            schema.StringAttribute{MarkdownDescription: "Hostname sent with SMTP EHLO. Coolify v4.x after #11398 (tip/nightly 4.3.10); not in tag v4.3.9.", Computed: true},
