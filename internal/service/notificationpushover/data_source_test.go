...
func TestNotificationDataSource_Read(t *testing.T) {
	t.Parallel()
	store := &mockPushover{EventStore: notificationcommon.EventStore{ServerDiskUsage: true}}
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.coolify_notification_pushover.test", "server_disk_usage", "true"),
				),
			},
		},
	})
