...
func TestEnvironmentResource_CreateAPIError(t *testing.T) {
	t.Parallel()
	mux := http.NewServeMux()
	mux.HandleFunc("POST /api/v1/projects/{projectUUID}/environments", func(w http.ResponseWriter, _ *http.Request) {
