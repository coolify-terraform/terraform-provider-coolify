...
func coveredEndpoints() map[string]coverageStatus {
	...
	return map[string]coverageStatus{
		...
		"GET /notifications/pushover":                                                   planned(2, "Notification channel resources (#704)"),
		...
		"GET /notifications/webhook":                                                    planned(2, "Notification channel resources (#704)"),
		...
		"PATCH /notifications/pushover":                                                 planned(2, "Notification channel resources (#704)"),
		...
		"PATCH /notifications/webhook":                                                  planned(2, "Notification channel resources (#704)"),
