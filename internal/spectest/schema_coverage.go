...
var environmentVariableSchemaRegistry = []SchemaCoverageEntry{
	...
	{ContractField: "is_shown_once", SchemaAttribute: "is_shown_once", Status: StatusCovered},
	{ContractField: "is_required", Status: SkipNA, Notes: "not on env write $allowedFields"},
	{ContractField: "is_shared", Status: SkipNA, Notes: "not on env write $allowedFields"},
	{ContractField: "order", Status: SkipNA, Notes: "not on env write $allowedFields"},
