...
var applicationSettingsSchemaRegistry = []SchemaCoverageEntry{
	...
	// Settings not on ApplicationsController APPLICATION_SETTING_FIELDS (UI-only).
	...
	{ContractField: "gpu_count", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	{ContractField: "gpu_device_ids", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	{ContractField: "gpu_driver", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	{ContractField: "gpu_options", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	...
	{ContractField: "is_consistent_container_name_enabled", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	...
	{ContractField: "is_gpu_enabled", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
	...
	{ContractField: "is_log_drain_enabled", Status: SkipNA, Notes: "not in ApplicationsController APPLICATION_SETTING_FIELDS public allow-list"},
