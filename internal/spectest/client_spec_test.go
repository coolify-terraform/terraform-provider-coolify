...
func TestClientEndpoints_SpecCompliance(t *testing.T) {
	...
	endpoints := []endpoint{
		...
		{"UpsertAppVolumeBackup", "PUT", "/api/v1/applications/app-1/storages/stor-1/backups",
			client.UpsertVolumeBackupInput{Frequency: "0 2 * * *"},
			201, map[string]interface{}{"uuid": "vb-1", "storage_uuid": "stor-1", "frequency": "0 2 * * *"}},
		{"DeleteAppVolumeBackup", "DELETE", "/api/v1/applications/app-1/storages/stor-1/backups",
			nil, 200, map[string]string{"message": "deleted"}},
		...
		{"UpdateDbStorage", "PATCH", "/api/v1/databases/db-1/storages",
			...
			200, map[string]interface{}{"id": 1, "message": "updated"}},
		{"UpsertDbVolumeBackup", "PUT", "/api/v1/databases/db-1/storages/stor-1/backups",
			client.UpsertVolumeBackupInput{Frequency: "0 2 * * *"},
			201, map[string]interface{}{"uuid": "vb-2", "storage_uuid": "stor-1", "frequency": "0 2 * * *"}},
		{"DeleteDbVolumeBackup", "DELETE", "/api/v1/databases/db-1/storages/stor-1/backups",
			nil, 200, map[string]string{"message": "deleted"}},
		...
		{"UpdateSvcStorage", "PATCH", "/api/v1/services/svc-1/storages",
			...
			200, map[string]interface{}{"id": 1, "message": "updated"}},
		{"UpsertSvcVolumeBackup", "PUT", "/api/v1/services/svc-1/storages/stor-1/backups",
			client.UpsertVolumeBackupInput{Frequency: "0 2 * * *"},
			201, map[string]interface{}{"uuid": "vb-3", "storage_uuid": "stor-1", "frequency": "0 2 * * *"}},
		{"DeleteSvcVolumeBackup", "DELETE", "/api/v1/services/svc-1/storages/stor-1/backups",
			nil, 200, map[string]string{"message": "deleted"}},
