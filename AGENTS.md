...
33 resources, 44 data sources, 850+ tests (unit + acceptance), 8 CI jobs.
16 ACME Corp scenario examples (all with `terraform test` integration tests; acme-private-repo, acme-preview-deploy, acme-github-cicd, and acme-hetzner-infra use plan-only).
