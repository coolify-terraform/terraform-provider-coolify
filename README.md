...
9 jobs in the CI workflow: Detect Changes, Test, Lint, Validate (includes
examples, docs, Trivy, Gitleaks), Scenario Tests, Acceptance Tests, Acceptance
Cloud, Contract Freshness (weekly), and a CI gate job.
