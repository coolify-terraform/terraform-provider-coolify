...
A Terraform provider for managing resources in [Coolify](https://coolify.io/), the open-source, self-hosted Platform-as-a-Service. 25 resources, 44 data sources, 600+ tests, 99%+ API coverage.
...
make test        # Run unit tests (600+ tests, race detector enabled)
