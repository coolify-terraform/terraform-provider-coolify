...
**27 resources, 44 data sources, 99%+ Coolify API coverage.**
...
| Operations | `coolify_environment_variable`, `coolify_storage`, `coolify_scheduled_task`, `coolify_deployment`, `coolify_resource_action`, `coolify_database_backup` |
