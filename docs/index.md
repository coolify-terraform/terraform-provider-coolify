...
**33 resources, 44 data sources, 99%+ Coolify API coverage.**
...
| Validation | `coolify_server_validate`, `coolify_cloud_token_validate`, `coolify_api_settings` |
...
`coolify_server_validate`, `coolify_resource_action`) are lifecycle-only and do not
