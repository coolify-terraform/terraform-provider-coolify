...
page_title: "coolify_docker_compose_application Resource - terraform-provider-coolify"
subcategory: ""
description: |-
...
- `docker_compose_custom_build_command` (String) Custom build command for Docker Compose.
- `docker_compose_custom_start_command` (String) Custom start command for Docker Compose.
- `docker_compose_domains` (String) Domain mappings for Docker Compose services.
- `docker_compose_location` (String) The location of the Docker Compose file relative to the repository root.
