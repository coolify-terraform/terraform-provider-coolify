...
- `docker_compose_location` (String) The path to the Docker Compose file within the application's base directory. Must start with `/`. When omitted, Coolify defaults to `/docker-compose.yaml`.
